...
import { Zap } from 'lucide-react' // Eksik olan mühür tam olarak burası kanka!
...
export default function PromoInput() {
  return (
    <div className="bg-gradient-to-br from-slate-900 to-blue-900 p-8 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden">
      <div className="relative z-10 space-y-4">
        ...
        <div className="flex gap-2">
          <input 
            ...
            className="flex-1 bg-white/10 border border-white/20 rounded-2xl px-6 py-4 outline-none focus:bg-white/20 font-black uppercase placeholder:text-white/30 text-white"
          />
      ...
      {/* İşte hata veren satır burasıydı, artık Zap'ı yukarıda tanıttık */}
